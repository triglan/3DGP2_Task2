...
public:
	...
	Vector GetVectorSet() {
		//return { Vec.Up, Vec.Right, Vec.Look };
		return Vec;
	}
	...
	void Update(float FT) {
		...
		//std::cout << HeliRotation.x << " y : " << HeliRotation.y << " z : " << HeliRotation.z << std::endl;
		//std::cout << Position.x << " y : " << Position.y << " z : " << Position.z << std::endl;
